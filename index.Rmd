...
ggplot(centro_america, aes(x=reorder(name_long, -lifeExp), y= lifeExp)) +
  ggtitle("Esperanza de vida de los siete países de Centroamérica") +
  xlab("Países") + 
  ylab("Esperanza de vida") +  
  geom_col() +
  geom_text(aes(label=lifeExp), vjust=-0.3, size=4)
...
```{r}
plot(centro_america["lifeExp"], main="Esperanza de vida de los siete países de Centroamérica")
...
centro_america2 <- world[world$name_long == "Belize" & world$lifeExp >= "74" |
                       world$name_long == "Guatemala" & world$lifeExp >= "74"|
                       world$name_long == "Honduras" & world$lifeExp >= "74"|
                       world$name_long == "El Salvador" & world$lifeExp >= "74"|
                       world$name_long == "Nicaragua" & world$lifeExp >= "74"|
                       world$name_long == "Costa Rica" & world$lifeExp >= "74"|
                       world$name_long == "Panama" & world$lifeExp >= "74", ]
plot(centro_america2["lifeExp"], main=" Países de CA con esperanza de vida mayor o igual a 74 años")
